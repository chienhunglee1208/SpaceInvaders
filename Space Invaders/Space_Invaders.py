...
turtle.onkey(fire_ebullet, "space")
...
while True:
	...
	#Check for a collision between the ebullet and the player
	...
	#Check to see if the bullet has gone to the floor
	if ebullet.ycor() < -275:
	    ebullet.hideturtle()
		ebulletstate = "ready"
